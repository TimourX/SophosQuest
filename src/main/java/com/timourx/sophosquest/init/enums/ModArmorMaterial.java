...
public enum ModArmorMaterial implements IArmorMaterial {
    EARTH_CRYTSAL(SophosQuest.MOD_ID + ":earth_crystal", 23, new int[] { 3, 5, 6, 2}, 3, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.2f, () -> { return Ingredient.fromItems(ModItems.EARTH_CRYSTAL.get());}, 0.05f),
